...
- narration: exactly ONE sentence, spoken aloud. Use a fixed word budget: scene 1 is EXACTLY 9 concrete words; every later scene is EXACTLY 11 words. That produces 108 words for 10 scenes, safely inside the ${config.content.minNarrationWords}-${config.content.maxNarrationWords} limit. Count speakable words, including every word in contractions, before answering. No jargon, emojis, hashtags, or markdown.
