...
export const DIAGRAM_COMPONENTS = [
  ...
  c('MouldCastPlate', 'engine/draw/MouldCast.tsx',
    'ONE silhouette through burial, decay, void, infill and cast — a mould made and then read back',
    'a shape that survives its own process: if the object is still there at the end, it is a ProcessPlate'),
  c('TerrainSectionPlate', 'engine/draw/TerrainSection.tsx',
    'the land from the side: a profile, beds under it, water standing in it, a structure holding it, and a mass that releases along a plane and displaces the water',
    'a plan view of a place — a section cannot show where two things are relative to each other, only what is under and above'),
